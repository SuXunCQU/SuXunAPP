...
class Index extends Component {
  ...
  state = {
    info: {
      ...
      gender: 1,
      age: 28,
      homeLocationName: "重庆市沙坪坝区大学城南路重庆市沙坪坝区大学城南路重庆市沙坪坝区大学城南路重庆市沙坪坝区大学城南路",
    ...
    return (
      <View>
        ...
        <Header
            ...
            rightComponent={{ type: "antdesign", icon: "setting", color: Color.icon.active, onPress: this.toSetting }}
        />
        {/* 1.0 标题栏 结束 */}
        <ScrollView>
          {/*  2.0 个人资料 开始 */}
          <View style={styles.details}>
            ...
            <View style={styles.info}>
              <View style={styles.firstInfo}>
                ...
                <Text style={styles.ID} selectable={true}>ID {info.id}</Text>
              </View>
              <Text style={styles.infoFont}>性别：{info.gender ? "男" : "女"}</Text>
              <Text style={styles.infoFont}>年龄：{info.age}</Text>
              <Text style={styles.infoFont} selectable={true}
                    textBreakStrategy="balanced">位置：{info.homeLocationName}</Text>
              <Text style={styles.infoFont} selectable={true}>电话：{info.phoneNumber}</Text>
              <Text style={styles.infoFont} selectable={true}>微信：{info.wechat}</Text>
              <Text style={styles.infoFont} selectable={true}>Q Q：{info.QQ}</Text>
            </View>
            {/*  2.2 个人信息 结束 */}
          </View>
          {/* 2.0 个人资料 结束 */}
          ...
          <View style={styles.navigation}>
            <Text onPress={this.changeTab(COMPLETION)} style={{
              ...styles.navigationText,
              color: selectedTab == COMPLETION ? Color.font.header : "black",
            }}>已完成</Text>
            <Text onPress={this.changeTab(ACHIEVEMENT)} style={{
              ...styles.navigationText,
              color: selectedTab == ACHIEVEMENT ? Color.font.header : "black",
            }}>成就</Text>
          </View>
          {/* 3.0 导航栏 结束 */}
          {/* 4.0 内容 开始 */}
          <View>
            {selectedTab == COMPLETION ? this.renderCompletion() : this.renderAchievement()}
          </View>
          {/* 4.0 内容 结束 */}
        </ScrollView>
      </View>
